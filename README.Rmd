...
1. To assess which ICD-9-CM and ICD-10-CM code set for APACHE II, APACHE III, and SAPS II scoring would be most reliable and practical for use in retrospective cohort studies.
...
1. The difference in number of comorbidities identified by electronic and manual scoring for each risk score.
1. The number of comorbidities identified by electronic or by manual scoring but not by both.
...
1. [Analysis for ASHP poster](https://bgulbis.github.io/Risk_Score_Validation/report/analysis_ashp_poster.nb.html)
1. [Supplemental Material for ASHP Poster](http://rpubs.com/bgulbis/ashp_poster_supplement)
