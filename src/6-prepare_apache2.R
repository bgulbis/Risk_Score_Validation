...
tmp_comorbid <- c(data_comorbidities, list(tmp_manual))
...
walk2(tmp_comorbid, comorbid_names, ~saveRDS(.x, file=paste0("data/final/data_comorbidities_", .y, ".Rds")))
